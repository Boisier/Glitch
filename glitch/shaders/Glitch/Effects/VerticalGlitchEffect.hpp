...
#ifndef VerticalGlitchEffect_h
#define VerticalGlitchEffect_h
...
class VerticalGlitchEffect {
	public:
	// Initialization methods

	VerticalGlitchEffect() {}
